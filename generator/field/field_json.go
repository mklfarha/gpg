...
func JSONFieldTemplate(f entity.Field, e entity.Entity, prefix *string) Template {
	...
	return Template{
		...
		Type:                       fieldType,
		SingularType:               helpers.ToCamelCase(singularIdentifier),
		...
		GraphGenToMapper:           fmt.Sprintf("Map%s%s(i.%s)", helpers.ToCamelCase(e.Identifier), helpers.ToCamelCase(singularIdentifier), helpers.ToCamelCase(f.Identifier)),
		GraphGenFromMapperParam:    "",
		GraphGenFromMapper:         fmt.Sprintf("Map%s%sInput(i.%s)", helpers.ToCamelCase(e.Identifier), helpers.ToCamelCase(singularIdentifier), helpers.ToCamelCase(f.Identifier)),
		GraphGenFromMapperOptional: fmt.Sprintf("Map%s%sInput(i.%s)", helpers.ToCamelCase(e.Identifier), helpers.ToCamelCase(singularIdentifier), helpers.ToCamelCase(f.Identifier)),
		ProtoType:                  protoType,
